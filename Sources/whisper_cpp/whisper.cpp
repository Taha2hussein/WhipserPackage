...
int whisper_full(
        ...
        const float * samples,
        int n_samples,int (*result_callback)(const char*,const char*,const char*)) {
                    ...
                    if (!text.empty()) {
                        if (params.print_realtime) {
                            if (params.print_timestamps) {
                                ...
                                result_callback(to_timestamp(t0).c_str(), to_timestamp(t1).c_str(), text.c_str());
                            } else {
                                printf("%s", text.c_str());
                                fflush(stdout);
                            }
